import { Store, newTable, nextTableName, newColumn, newSequence, newView, emptyModel, uid, uniqueName, TABLE_COLORS } from './model.js?v=202609181149';
import { TEMPLATES, COLUMN_PRESETS } from './templates.js?v=202609181149';
import { checkModel, fixFkIndexes, fixPkNaming } from './checks.js?v=202609181149';
import { Diagram, tableSize, viewSize, resolveOverlaps } from './diagram.js?v=202609181149';
import { DiagramTabs } from './diagrams-ui.js?v=202609181149';
import { Panel } from './panel.js?v=202609181149';
import { Sidebar } from './sidebar.js?v=202609181149';
import { Palette } from './palette.js?v=202609181149';
import { generateDDL, viewDDL } from './ddl-gen.js?v=202609181149';
import { parseDDL } from './ddl-parse.js?v=202609181149';
import { SAMPLE_DDL } from './sample.js?v=202609181149';
import { initWorkspace } from './workspace.js?v=202609181149';
import { diffModels } from './diff.js?v=202609181149';
import { dictionaryHTML, dictionaryMarkdown } from './docs.js?v=202609181149';
import { migrateModel, listSnapshots } from './storage.js?v=202609181149';
import { Sandbox } from './sandbox.js?v=202609181149';
import { t, getLang, setLang, onLang, applyStatic } from './i18n.js?v=202609181149';
