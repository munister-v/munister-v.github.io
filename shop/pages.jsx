  ...
  return (
    <div style={{ background: "var(--olv-bg)" }}>
      ...
      <div style={{ background: "var(--olv-ink)", color: "var(--olv-cream)", padding: "80px 28px 64px", textAlign: "center" }}>
        <div style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", opacity: 0.6, marginBottom: 16 }}>
          ◎ Gift sets · Curated by occasion
        </div>
        <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(44px, 5.5vw, 76px)", margin: "0 0 16px", fontWeight: 400, letterSpacing: "-0.015em", lineHeight: 1 }}>
          Give the good bottle.
        </h1>
        <p style={{ fontFamily: "var(--font-body)", fontSize: 16, opacity: 0.72, maxWidth: 520, marginInline: "auto", lineHeight: 1.6 }}>
      ...
      <div style={{ background: "var(--olv-cream)", padding: "22px 28px", borderBottom: "1px solid rgba(31,42,26,0.07)", position: "sticky", top: 0, zIndex: 20 }}>
        <div style={{ maxWidth: 1400, marginInline: "auto", display: "flex", gap: 8, flexWrap: "wrap", alignItems: "center" }}>
          <span style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--olv-ink-soft)", marginRight: 4 }}>Occasion:</span>
          {occasions.map(o => (
            <button key={o.id} onClick={() => setOccasion(o.id)} style={{
              ...
              fontFamily: "var(--font-body)", fontSize: 12.5, cursor: "pointer", transition: "all .15s",
            }}>{o.label}</button>
          ))}
        </div>
      </div>
      ...
      <div style={{ maxWidth: 1400, marginInline: "auto", padding: "52px 28px 90px" }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ fontFamily: "var(--font-display)", fontSize: 28, letterSpacing: "-0.01em", marginBottom: 8 }}>
              Free handwritten gift note with every order.
            </div>
            <div style={{ fontFamily: "var(--font-body)", fontSize: 14, color: "var(--olv-ink)", opacity: 0.8, lineHeight: 1.55 }}>
          ...
          <button style={{
            ...
            padding: "14px 24px", borderRadius: 999, fontFamily: "var(--font-body)",
  ...
  return (
    <div ref={ref} onMouseEnter={() => setHover(true)} onMouseLeave={() => setHover(false)}
      ...
      <div style={{ background: "var(--olv-cream)", padding: "24px 22px" }}>
        <div style={{ fontFamily: "var(--font-display)", fontSize: 24, letterSpacing: "-0.01em", marginBottom: 8 }}>{b.name}</div>
        <p style={{ fontFamily: "var(--font-body)", fontSize: 13.5, color: "var(--olv-ink-soft)", lineHeight: 1.55, marginBottom: 14 }}>{b.desc}</p>
        <ul style={{ listStyle: "none", padding: 0, margin: "0 0 18px", display: "flex", flexDirection: "column", gap: 5 }}>
          {b.items.map(item => (
            <li key={item} style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.12em", textTransform: "uppercase", color: "var(--olv-ink-soft)", display: "flex", gap: 8, alignItems: "center" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
          <div>
            <div style={{ fontFamily: "var(--font-display)", fontSize: 28 }}>${b.price}</div>
            <div style={{ fontFamily: "var(--font-body)", fontSize: 12, color: "var(--olv-ink-soft)", textDecoration: "line-through" }}>${b.price + b.saving} if bought separately</div>
          </div>
    ...
    <div style={{ background: "var(--olv-bg)" }}>
      ...
      <div style={{ padding: "72px 28px 48px", background: "var(--olv-cream)", borderBottom: "1px solid rgba(31,42,26,0.07)" }}>
        <div style={{ maxWidth: 1400, marginInline: "auto" }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--olv-moss)", marginBottom: 12 }}>◓ The journal</div>
          <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(44px, 5vw, 72px)", margin: "0 0 24px", fontWeight: 400, letterSpacing: "-0.015em", lineHeight: 1 }}>
            Field notes & recipes.
          </h1>
        ...
        {featured && (
          <a href="#" style={{ textDecoration: "none", color: "var(--olv-ink)", display: "grid", gridTemplateColumns: "1.4fr 1fr", gap: 0, marginBottom: 52, background: "var(--olv-cream)" }}>
            <div style={{ position: "relative", aspectRatio: "16/9" }}>
              ...
              <span style={{ position: "absolute", top: 16, left: 16, background: "var(--olv-ink)", color: "var(--olv-cream)", fontFamily: "var(--font-mono)", fontSize: 10, letterSpacing: "0.14em", textTransform: "uppercase", padding: "6px 10px" }}>Featured</span>
            </div>
            <div style={{ padding: "44px 44px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 14 }}>
              <div style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--olv-moss)" }}>{featured.tag} · {featured.readTime} read</div>
              <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(24px, 2.4vw, 34px)", margin: 0, fontWeight: 400, lineHeight: 1.15, letterSpacing: "-0.01em" }}>{featured.title}</h2>
              <span style={{ fontFamily: "var(--font-body)", fontSize: 13, color: "var(--olv-moss)", display: "inline-flex", alignItems: "center", gap: 6 }}>Read article <Icon.arrow /></span>
            </div>
          </a>
        )}
          ...
          {rest.map((a, i) => (
            <a key={a.id} href="#" style={{ textDecoration: "none", color: "var(--olv-ink)", display: "block",
              ...
              <div style={{ marginTop: 14 }}>
                <div style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.18em", textTransform: "uppercase", color: "var(--olv-moss)", marginBottom: 8 }}>{a.tag} · {a.readTime} read</div>
                <h3 style={{ fontFamily: "var(--font-display)", fontSize: 22, margin: 0, fontWeight: 400, lineHeight: 1.2, letterSpacing: "-0.005em" }}>{a.title}</h3>
              </div>
            </a>
          ))}
        </div>
  ...
  return (
    <div style={{ background: "var(--olv-bg)" }}>
      ...
      <div style={{ background: "var(--olv-amber)", padding: "96px 28px", textAlign: "center" }}>
        <div style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--olv-ink)", opacity: 0.65, marginBottom: 18 }}>✶ Our story</div>
        <h1 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(40px, 5vw, 72px)", margin: "0 0 24px", fontWeight: 400, letterSpacing: "-0.015em", lineHeight: 1.05, maxWidth: 900, marginInline: "auto" }}>
          We started Munister with one press, fourteen growers, and one rule.
        </h1>
        <p style={{ fontFamily: "var(--font-display)", fontSize: "clamp(20px, 2.4vw, 28px)", color: "var(--olv-ink)", opacity: 0.8, maxWidth: 640, marginInline: "auto", fontStyle: "italic", lineHeight: 1.4 }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", background: "var(--olv-cream)" }}>
        ...
        <div style={{ padding: "72px 60px", display: "flex", flexDirection: "column", justifyContent: "center", gap: 20 }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 10.5, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--olv-moss)" }}>Founder's note</div>
          <blockquote style={{ fontFamily: "var(--font-display)", fontSize: "clamp(24px, 2.8vw, 36px)", margin: "0 0 18px", fontWeight: 400, lineHeight: 1.18, letterSpacing: "-0.01em", color: "var(--olv-ink)" }}>
          ...
          <p style={{ fontFamily: "var(--font-body)", fontSize: 15, lineHeight: 1.65, color: "var(--olv-ink-soft)", margin: 0 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 14, marginTop: 8 }}>
            ...
            <div>
              <div style={{ fontFamily: "var(--font-display)", fontSize: 18 }}>Marta Solovei</div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 12, color: "var(--olv-ink-soft)" }}>Founder & Head Presser · Munister Co-operative · Iza, 2019</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div style={{ padding: "90px 28px", background: "var(--olv-bg)" }}>
        <div style={{ maxWidth: 860, marginInline: "auto" }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", color: "var(--olv-moss)", marginBottom: 14 }}>◐ Timeline</div>
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(34px, 3.6vw, 48px)", margin: "0 0 52px", fontWeight: 400, letterSpacing: "-0.01em" }}>Six years. Fourteen farms. One rule.</h2>
          {milestones.map((m, i) => (
            <div key={m.year} style={{ display: "grid", gridTemplateColumns: "100px 1fr", gap: 28, paddingBottom: 36, borderLeft: "1px solid rgba(31,42,26,0.12)", marginLeft: 50, position: "relative" }}>
              ...
              <div style={{ fontFamily: "var(--font-display)", fontSize: 24, color: "var(--olv-ink)", paddingLeft: 24 }}>{m.year}</div>
              <div style={{ fontFamily: "var(--font-body)", fontSize: 15, lineHeight: 1.65, color: "var(--olv-ink)", paddingTop: 4 }}>{m.event}</div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div style={{ background: "var(--olv-ink)", color: "var(--olv-cream)", padding: "80px 28px" }}>
        <div style={{ maxWidth: 1200, marginInline: "auto" }}>
          <div style={{ fontFamily: "var(--font-mono)", fontSize: 11, letterSpacing: "0.22em", textTransform: "uppercase", opacity: 0.6, marginBottom: 14 }}>◑ How we operate</div>
          <h2 style={{ fontFamily: "var(--font-display)", fontSize: "clamp(32px, 3.4vw, 46px)", margin: "0 0 48px", fontWeight: 400, letterSpacing: "-0.01em" }}>The things we won't compromise on.</h2>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(2, 1fr)", gap: 32 }}>
            {values.map(v => (
              <div key={v.title} style={{ borderTop: "1px solid rgba(255,255,255,0.14)", paddingTop: 24 }}>
                <div style={{ fontFamily: "var(--font-display)", fontSize: 36, marginBottom: 10, color: "var(--olv-amber)" }}>{v.icon}</div>
                <div style={{ fontFamily: "var(--font-display)", fontSize: 24, marginBottom: 12, letterSpacing: "-0.01em" }}>{v.title}</div>
                <div style={{ fontFamily: "var(--font-body)", fontSize: 14.5, lineHeight: 1.65, opacity: 0.75 }}>{v.desc}</div>
              </div>
            ))}
          </div>
        </div>
